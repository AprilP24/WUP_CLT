...
Put the standard deviation and insert it in the data that is from the central limit. The standard deviation shrinks whenever the number gets higher , example 4 is divided by 2 , 9 is divided by 3 and so on. 
...
print(paste('mean = ', mean(my1000$k4),' sd = ',sd(my1000$k4)))
```
the standard deviation is now a quarter of what it was before, and now it is 10
Also the standard deviation continues to shrink with this number value. 
...
What I expected was still little off from what the code gave me for the value we are expecting. And The standard deviation continues to shrink too.  
...
I expected value to be 6 but I was off a little and instead it rounds up to 7 with the code. 